...
const CACHE_KEY = "admin:interviews";
...
export default function AdminInterviewsPage() {
  ...
  const load = () => {
    ...
    setError(null);
    loadWithCache(CACHE_KEY, () => getAdminInterviews({ limit: 100 }), CACHE_TTL.admin)
      .then(setSessions)
      .catch(setError)
  ...
  if (loading && !sessions.length) return <LoadingState label="Loading interviews..." />;
